...
<body>
	...
	<form id="listForm" action="list.jhtml" method="get">
		<div class="bar">
			<a href="backup.jhtml" class="iconButton">
				<span class="addIcon">&nbsp;</span>备份
			</a>
		...
		<table id="listTable" class="list">
			...
			[#list list as friendLink]
				<tr>
					...
					<td>
						${friendLink.lastModified}
					</td>
					<td>
						<span title="${friendLink.lastModified?string("yyyy-MM-dd HH:mm:ss")}">${friendLink.lastModified}</span>
					</td>
					<td>
