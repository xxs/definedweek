 ...
 * 模板指令 - 下级导航分类列表
 */
@Component("navigationChildrenListDirective")
public class NavigationChildrenListDirective extends BaseDirective {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if (navigationId != null && navigation == null) {
			...
			if (useCache) {
				productCategories = navigationService.findChildren(navigation, count, cacheRegion);
			} else {
				productCategories = navigationService.findChildren(navigation, count);
			}
		}
