...
public interface OrderService extends BaseService<Order, Long> {
	 ...
	 * @return 订单
	 */
	List<Order> findList(Member member, Integer count, List<Filter> filters,
			List<com.xxs.definedweek.Order> orders);
	 ...
	 * @return 商品分页
	 */
	Page<Order> findPage(OrderStatus orderStatus, PaymentStatus paymentStatus,
	 ...
	 * @return 订单数量
	 */
	Long count(OrderStatus orderStatus, PaymentStatus paymentStatus,
			Boolean hasExpired);
	 ...
	 * @return 订单
	 */
	Order build(Cart cart,PaymentMethod paymentMethod,
	 ...
	 * @return 订单
	 */
	Order create(Cart cart, PaymentMethod paymentMethod,
			CouponCode couponCode, boolean isInvoice, String invoiceTitle,
