...
import com.xxs.definedweek.util.HibernateUtils;
...
public class MonitorHibernateCacheController extends BaseController {
    ...
    public String index(Model model) {
        ...
        return "/admin/monitor/hibernate/index";
    }
    ...
    @RequestMapping("/queryCache")
     public String queryCache() {
        return "/admin/monitor/hibernate/queryCache";
    }
    ...
    public String secondLevelCache(Model model) {
        setMemoryInfo(model);
        return "/admin/monitor/hibernate/secondLevelCache";
    }
    ...
    public String entityAndCollectionCRUDCount() {
        return "/admin/monitor/hibernate/entityAndCollectionCRUDCount";
    }
    ...
    public String showControlForm() {
        return "/admin/monitor/hibernate/controlForm";
    }
