...
INSERT INTO `xx_brand` VALUES ('20', '2014-12-07 20:26:54', '2014-12-07 20:26:54', null, null, null, '师说cms', '0', null);
INSERT INTO `xx_brand` VALUES ('21', '2014-12-07 20:27:14', '2014-12-07 20:27:14', null, null, null, '蘑菇cms', '0', null);
INSERT INTO `xx_brand` VALUES ('22', '2014-12-07 20:27:47', '2014-12-07 20:27:47', null, null, null, 'javashop网店系统', '0', null);
INSERT INTO `xx_brand` VALUES ('23', '2014-12-07 20:27:58', '2014-12-07 20:27:58', null, null, null, 'shop++网店系统', '0', null);
...
INSERT INTO `xx_goods` VALUES ('67', '2014-12-10 21:43:13', '2014-12-10 21:43:13');
...
INSERT INTO `xx_log` VALUES ('6', '2014-12-10 22:11:17', '2014-12-10 22:11:17', null, '127.0.0.1', '系统设置', 'admin', 'phone = \nisTaxPriceEnabled = true\nimageUploadPath = /upload/image/${.now?string(\'yyyyMM\')}/\nsmtpUsername = test\ndefaultThumbnailProductImage = /upload/image/default_thumbnail.jpg\npriceRoundType = roundHalfUp\ncerttext = \nmediumProductImageHeight = 300\nuploadMediaExtension = swf,flv,mp3,wav,avi,rm,rmvb\nisReviewCheck = true\nisInvoiceEnabled = true\nregisterPoint = 0\nisSiteEnabled = true\nzipCode = 450000\nuploadFileExtension = zip,rar,7z,doc,docx,xls,xlsx,ppt,pptx\nisShowMarketPrice = true\nlargeProductImageHeight = 800\nreviewAuthority = purchased\nwatermarkAlpha = 50\nsmtpHost = smtp.definedweek.net\nisConsultationEnabled = true\ntaxRate = 0.06\n_isEmailLogin = false\nisRegisterEnabled = true\nwatermarkPosition = bottomRight\n_isSiteEnabled = false\nregisterAgreement = <p>尊敬的用户欢迎您注册成为本网站会员。请用户仔细阅读以下全部内容。如用户不同意本服务条款任意内容，请不要注册或使用本网站服务。如用户通过本网站注册程序，即表示用户与本网站已达成协议，自愿接受本服务条款的所有内容。此后，用户不得以未阅读本服务条款内容作任何形式的抗辩。</p> <p>一、本站服务条款的确认和接纳<br />本网站涉及的各项服务的所有权和运作权归本网站所有。本网站所提供的服务必须按照其发布的服务条款和操作规则严格执行。本服务条款的效力范围及于本网站的一切产品和服务，用户在享受本网站的任何服务时，应当受本服务条款的约束。</p> <p>二、服务简介<br />本网站运用自己的操作系统通过国际互联网络为用户提供各项服务。用户必须:  1. 提供设备，如个人电脑、手机或其他上网设备。 2. 个人上网和支付与此服务有关的费用。</p> <p>三、用户在不得在本网站上发布下列违法信息<br />1. 反对宪法所确定的基本原则的； 2. 危害国家安全，泄露国家秘密，颠覆国家政权，破坏国家统一的； 3. 损害国家荣誉和利益的； 4. 煽动民族仇恨、民族歧视，破坏民族团结的； 5. 破坏国家宗教政策，宣扬邪教和封建迷信的； 6. 散布谣言，扰乱社会秩序，破坏社会稳定的； 7. 散布淫秽、色情、赌博、暴力、凶杀、恐怖或者教唆犯罪的； 8. 侮辱或者诽谤他人，侵害他人合法权益的； 9. 含有法律、行政法规禁止的其他内容的。</p> <p>四、有关个人资料<br />用户同意:  1. 提供及时、详尽及准确的个人资料。 2. 同意接收来自本网站的信息。 3. 不断更新注册资料，符合及时、详尽准确的要求。所有原始键入的资料将引用为注册资料。 4. 本网站不公开用户的姓名、地址、电子邮箱和笔名。除以下情况外:  a) 用户授权本站透露这些信息。 b) 相应的法律及程序要求本站提供用户的个人资料。</p> <p>五、服务条款的修改<br />本网站有权在必要时修改服务条款，一旦条款及服务内容产生变动，本网站将会在重要页面上提示修改内容。如果不同意所改动的内容，用户可以主动取消获得的本网站信息服务。如果用户继续享用本网站信息服务，则视为接受服务条款的变动。</p> <p>六、用户隐私制度<br />尊重用户个人隐私是本网站的一项基本政策。所以，本网站一定不会在未经合法用户授权时公开、编辑或透露其注册资料及保存在本网站中的非公开内容，除非有法律许可要求或本网站在诚信的基础上认为透露这些信息在以下四种情况是必要的:  1. 遵守有关法律规定，遵从本网站合法服务程序。 2. 保持维护本网站的商标所有权。 3. 在紧急情况下竭力维护用户个人和社会大众的隐私安全。 4. 符合其他相关的要求。</p> <p>七、用户的帐号、密码和安全性<br />用户一旦注册成功，将获得一个密码和用户名。用户需谨慎合理的保存、使用用户名和密码。如果你不保管好自己的帐号和密码安全，将负全部责任。另外，每个用户都要对其帐户中的所有活动和事件负全责。你可随时根据指示改变你的密码。用户若发现任何非法使用用户帐号或存在安全漏洞的情况，请立即通告本网站。   八、 拒绝提供担保 用户明确同意信息服务的使用由用户个人承担风险。本网站不担保服务不会受中断，对服务的及时性，安全性，出错发生都不作担保，但会在能力范围内，避免出错。</p> <p>九、有限责任<br />如因不可抗力或其它本站无法控制的原因使本站销售系统崩溃或无法正常使用导致网上交易无法完成或丢失有关的信息、记录等本站会尽可能合理地协助处理善后事宜，并努力使客户免受经济损失，同时会尽量避免这种损害的发生。</p> <p>十、用户信息的储存和限制<br />本站有判定用户的行为是否符合国家法律法规规定及本站服务条款权利，如果用户违背本网站服务条款的规定，本网站有权中断对其提供服务的权利。</p> <p>十一、用户管理<br />用户单独承担发布内容的责任。用户对服务的使用是根据所有适用于本站的国家法律、地方法律和国际法律标准的。用户必须遵循:  1. 使用网络服务不作非法用途。 2. 不干扰或混乱网络服务。 3. 遵守所有使用网络服务的网络协议、规定、程序和惯例。 用户须承诺不传输任何非法的、骚扰性的、中伤他人的、辱骂性的、恐性的、伤害性的、庸俗的，淫秽等信息资料。另外，用户也不能传输何教唆他人构成犯罪行为的资料；不能传输助长国内不利条件和涉及国家安全的资料；不能传输任何不符合当地法规、国家法律和国际法律的资料。未经许可而非法进入其它电脑系统是禁止的。 若用户的行为不符合以上提到的服务条款，本站将作出独立判断立即取消用户服务帐号。用户需对自己在网上的行为承担法律责任。用户若在本站上散布和传播反动、色情或其它违反国家法律的信息，本站的系统记录有可能作为用户违反法律的证据。</p> <p>十二、通告<br />所有发给用户的通告都可通过重要页面的公告或电子邮件或常规的信件传送。服务条款的修改、服务变更、或其它重要事件的通告都会以此形式进行。</p> <p>十三、信息内容的所有权<br />本网站定义的信息内容包括: 文字、软件、声音、相片、录象、图表；在广告中全部内容；本网站为用户提供的其它信息。所有这些内容受版权、商标、标签和其它财产所有权法律的保护。所以，用户只能在本网站和广告商授权下才能使用这些内容，而不能擅自复制、再造这些内容、或创造与内容有关的派生产品。本站所有的文章版权归原文作者和本站共同所有，任何人需要转载本站的文章，必须征得原文作者或本站授权。</p> <p>十四、法律<br />本协议的订立、执行和解释及争议的解决均应适用中华人民共和国的法律。用户和本网站一致同意服从本网站所在地有管辖权的法院管辖。如发生本网站服务条款与中华人民共和国法律相抵触时，则这些条款将完全按法律规定重新解释，而其它条款则依旧保持对用户的约束力。</p>\naccountLockTime = 10\ndefaultPointScale = 1\nisEmailLogin = true\npasswordMinLength = 4\n_isTaxPriceEnabled = false\nhotSearch = opencms,jeecms,jspxcms,es\nemail = service@definedweek.net\nusernameMinLength = 2\ncookieDomain = \nusernameMaxLength = 20\n_isShowMarketPrice = false\nisConsultationCheck = true\nsiteCloseMessage = <dl><dt>网站维护中，暂时无法访问！</dt><dd>本网站正在进行系统维护和技术升级，网站暂时无法访问，敬请谅解！</dd></dl>\nuploadFlashExtension = swf,flv\npasswordMaxLength = 20\nuploadImageExtension = jpg,jpeg,bmp,gif,png\naccountLockTypes = member\naccountLockTypes = admin\nconsultationAuthority = member\ndefaultMediumProductImage = /upload/image/default_medium.jpg\nsiteUrl = http://127.0.0.1:8080\nsmtpPassword = \ncurrencyUnit = 元\n_isRegisterEnabled = false\ntoMail = \ntoken = b5d73e9d-3599-4cf9-b914-1647a2e61b71\ndefaultLargeProductImage = /upload/image/default_large.jpg\nsmtpFromMail = test@definedweek.net\nthumbnailProductImageHeight = 170\nisReviewEnabled = true\n_isConsultationCheck = false\nsiteName = 最专业的模板销售网站\nmediumProductImageWidth = 300\nsmtpPort = 25\nisDevelopmentEnabled = true\n_isConsultationEnabled = false\nlogo = /upload/image/logo.gif\n_isInvoiceEnabled = false\ncurrencySign = ￥\n_isReviewEnabled = false\nmediaUploadPath = /upload/media/${.now?string(\'yyyyMM\')}/\ncookiePath = /\nthumbnailProductImageWidth = 170\n_isReviewCheck = false\naccountLockCount = 5\npriceScale = 2\n_isDuplicateEmail = false\nsafeKeyExpiryTime = 1440\nlargeProductImageWidth = 800\naddress = 河南郑州财富广场\nflashUploadPath = /upload/flash/${.now?string(\'yyyyMM\')}/\n_isDevelopmentEnabled = false\ndisabledUsername = admin,管理员\nfileUploadPath = /upload/file/${.now?string(\'yyyyMM\')}/\nuploadMaxSize = 10\ndefaultMarketPriceScale = 1.2\n');
...
INSERT INTO `xx_member` VALUES ('2', '2014-11-15 15:49:16', '2014-12-06 13:09:20', '123123', '0.000000000000', null, null, null, null, null, null, null, null, null, null, '7970.000000000000', '2014-11-15 00:00:00', '123123@qq.com', '0', '', '\0', null, '2014-12-06 13:09:20', '0', '127.0.0.1', null, '123123', '4297f44b13955235245b2497399d7a93', null, '0', '127.0.0.1', null, null, '123123', null, '162', '1');
...
INSERT INTO `xx_navigation` VALUES ('4', '2014-11-03 00:00:20', '2014-12-10 22:14:50', null, '\0', '首页', '1', '/', null, '0', '', ',', null);
...
-- ----------------------------
INSERT INTO `xx_product` VALUES ('301', '2014-11-15 14:08:39', '2014-12-09 22:06:21', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'xx商城[opencms 9.5]', '16', 'http://127.0.0.1:8080/upload/image/201411/4c79b583-4781-4e0b-bf72-d5170ef3029a-thumbnail.jpg', '阿斯顿发送到发送到', '\0', '\0', '', '\0', 'opencms', '24.000000', null, '16', '2014-11-18 15:43:52', '0', '2014-11-15 14:08:38', 'xx商城', '20', '20.000000', '0', '0', '0', null, null, null, '201411606', '0', null, '0', null, '8', '2014-11-18 15:43:52', '0', '2014-11-15 14:08:38', null, '18', '63', '2', null);
INSERT INTO `xx_product` VALUES ('302', '2014-11-15 14:08:39', '2014-12-09 22:06:21', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'xx商城[opencms 9.x]', '13', null, '阿斯顿发送到发送到', '\0', '\0', '', '\0', 'opencms', '24.000000', null, '13', '2014-11-18 15:43:52', '0', '2014-11-15 14:08:38', 'xx商城', '20', '30.000000', '0', '0', '0', null, null, null, '201411607', null, null, '0', null, '7', '2014-11-18 15:43:52', '0', '2014-11-15 14:08:38', null, '18', '63', '2', null);
INSERT INTO `xx_product` VALUES ('303', '2014-11-15 14:08:39', '2014-12-09 22:06:21', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'xx商城[opencms 8.x]', '27', null, '阿斯顿发送到发送到', '\0', '\0', '', '\0', 'opencms', '24.000000', null, '27', '2014-11-18 15:43:52', '0', '2014-11-15 14:08:38', 'xx商城', '20', '40.000000', '0', '0', '0', null, null, null, '201411608', null, null, '0', null, '17', '2014-11-18 15:43:52', '0', '2014-11-15 14:08:38', null, '18', '63', '2', null);
INSERT INTO `xx_product` VALUES ('304', '2014-11-15 14:08:39', '2014-12-09 22:06:21', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'xx商城[opencms 7.x]', '42', 'http://127.0.0.1:8080/upload/image/banner/xiangyingshi.jpg', '<img align=\"absmiddle\" src=\"http://gd2.alicdn.com/imgextra/i2/2200505180/TB2UP8.apXXXXbhXXXXXXXXXXXX-2200505180.jpg\" style=\"margin:0px;padding:0px;vertical-align:top;font-family:tahoma, arial, 宋体, sans-serif;font-size:14px;line-height:21px;white-space:normal;background-color:#FFFFFF;\" />', '\0', '', '', '\0', 'opencms', '24.000000', null, '9', '2014-12-04 22:46:34', '0', '2014-11-15 14:08:38', 'xx商城', '20', '10.000000', '0', '4.33333', '3', null, null, null, '201411609', null, null, '13', null, '9', '2014-12-04 22:46:34', '0', '2014-11-15 14:08:38', null, '18', '63', '2', null);
INSERT INTO `xx_product` VALUES ('305', '2014-11-17 23:08:31', '2014-12-10 22:13:03', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'es 成熟的cms系统[es 1.0]', '15', null, null, '\0', '', '', '\0', 'es', '147.600000', 'es版本号', '5', '2014-12-04 21:27:43', '0', '2014-11-17 23:08:31', 'es 成熟的cms系统', '123', '123.000000', '0', '0', '0', 'es', 'es', 'es', '201411708', null, null, '0', null, '5', '2014-12-04 21:27:43', '0', '2014-11-17 23:08:31', null, null, '65', '85', null);
INSERT INTO `xx_product` VALUES ('306', '2014-11-18 12:23:09', '2014-12-09 22:20:00', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, '小米商城[jspxcms 4.0.1]', '15', 'http://127.0.0.1:8080/upload/image/201412/c39f684d-c6f9-4fc5-b9fb-cb39b2dee798-thumbnail.jpg', null, '\0', '\0', '', '', 'jspxcms', '18.000000', 'jspxcms', '2', '2014-12-04 21:45:21', '0', '2014-11-18 12:23:09', '小米商城', '15', '15.000000', '0', '0', '0', 'jspxcms', 'jspxcms', 'jspxcms', '201411707', null, null, '0', null, '2', '2014-12-04 21:45:21', '0', '2014-11-18 12:23:09', null, '4', '66', '10', null);
INSERT INTO `xx_product` VALUES ('307', '2014-11-18 12:23:09', '2014-12-09 22:20:07', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, '小米商城[jspxcms 4.1]', '6', null, '<dl class=\"discount\" style=\"padding:10px;margin:0px;font-size:14px;font-family:微软雅黑;color:#575757;line-height:normal;white-space:normal;background-color:#F1F1F1;\">\r\n	<dd style=\"padding:0px;margin:0px 0px 10px;color:red;font-size:20px;font-weight:bold;\">\r\n		Jspxcms4.1正式发布，为回馈广大用户，现产品6.6折优惠!\r\n	</dd>\r\n	<dt style=\"padding:0px;margin:0px;line-height:25px;\">\r\n		1、Jspxcms商业版授权费，原价5800元，现只需3800元。并赠送一次远程协助安装、一年使用技术支持（论坛、QQ、电话、邮箱）、一年二次开发支持（论坛）。\r\n	</dt>\r\n	<dt style=\"padding:0px;margin:0px;line-height:25px;\">\r\n		2、购买商业版授权的用户，免费提供后续版本升级包。\r\n	</dt>\r\n	<dt style=\"padding:0px;margin:0px;line-height:25px;\">\r\n		3、以上报价不含税，税费为10%。\r\n	</dt>\r\n</dl>\r\n<table class=\"purch-table ke-zeroborder\" width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"padding:0px;margin:0px;color:#575757;font-family:Arial, Helvetica, sans-serif, 微软雅黑, 宋体;font-size:12px;border-top-width:1px;border-top-color:#94CFE4;border-top-style:solid;background-color:#F1F1F1;\">\r\n	<tbody style=\"padding:0px;margin:0px;\">\r\n		<tr style=\"padding:0px;margin:0px;\">\r\n			<th width=\"30%\" align=\"center\" style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background-color:#E3F3EB;\">\r\n				版本类型\r\n			</th>\r\n			<th style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background-color:#E3F3EB;\">\r\n				开源版\r\n			</th>\r\n			<th width=\"30%\" style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background-color:#E3F3EB;\">\r\n				商业授权版\r\n			</th>\r\n		</tr>\r\n		<tr style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				前后台版权信息\r\n			</td>\r\n			<td align=\"left\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				需保留\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;\">\r\n				允许去除\r\n			</td>\r\n		</tr>\r\n		<tr style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				系统功能\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				网站常用功能\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;\">\r\n				更多企业级功能\r\n			</td>\r\n		</tr>\r\n		<tr style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				使用年限\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				永久\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;\">\r\n				永久\r\n			</td>\r\n		</tr>\r\n		<tr style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				升级年限\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				永久\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;\">\r\n				永久\r\n			</td>\r\n		</tr>\r\n		<tr style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				网站数量\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				1个\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;\">\r\n				1个\r\n			</td>\r\n		</tr>\r\n		<tr style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				授权价格\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				免费\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;\">\r\n				收费（联系售前）\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n<table class=\"purch-table ke-zeroborder\" width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"padding:0px;margin:0px;color:#575757;font-family:Arial, Helvetica, sans-serif, 微软雅黑, 宋体;font-size:12px;background-color:#F1F1F1;\">\r\n	<tbody style=\"padding:0px;margin:0px;\">\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<th colspan=\"6\" scope=\"col\" style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background-color:#E3F3EB;\">\r\n				服务范围\r\n			</th>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				服务类型明细\r\n			</td>\r\n			<td width=\"110\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				商业授权\r\n			</td>\r\n			<td width=\"110\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				企业普通型\r\n			</td>\r\n			<td width=\"110\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				企业增强型\r\n			</td>\r\n			<td width=\"110\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				企业银牌型\r\n			</td>\r\n			<td width=\"110\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;\">\r\n				企业金牌型\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				提供商业授权\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				授权版功能支持\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				官方网站商业用户账号\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n<table class=\"purch-table ke-zeroborder\" width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"padding:0px;margin:0px;color:#575757;font-family:Arial, Helvetica, sans-serif, 微软雅黑, 宋体;font-size:12px;background-color:#F1F1F1;\">\r\n	<tbody style=\"padding:0px;margin:0px;\">\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<th colspan=\"6\" scope=\"col\" style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background-color:#E3F3EB;\">\r\n				服务方式\r\n			</th>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				官方论坛商业区支持\r\n			</td>\r\n			<td width=\"110\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td width=\"110\" class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td width=\"110\" class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td width=\"110\" class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td width=\"110\" class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				E-mail 支持\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				QQ/MSN 支持\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				电话 支持\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				指定工程师一对一服务\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;\">\r\n				技术经理支持\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n<table class=\"purch-table ke-zeroborder\" width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"padding:0px;margin:0px;color:#575757;font-family:Arial, Helvetica, sans-serif, 微软雅黑, 宋体;font-size:12px;background-color:#F1F1F1;\">\r\n	<tbody style=\"padding:0px;margin:0px;\">\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<th colspan=\"6\" scope=\"col\" style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background-color:#E3F3EB;\">\r\n				服务内容\r\n			</th>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				程序安装指导\r\n			</td>\r\n			<td width=\"110\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td width=\"110\" class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td width=\"110\" class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td width=\"110\" class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td width=\"110\" class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				程序升级指导\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td width=\"110\" class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				程序使用指导\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				程序BUG反馈解决\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				程序安全设置\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				系统故障排除\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				代安装、升级服务\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				1次\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				2次\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;\">\r\n				2次\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				服务器间网站数据迁移\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				1次\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				2次\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;\">\r\n				4次\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				网站数据库安全备份\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				1次\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				2次\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;\">\r\n				3次\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				运行环境安装\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				运行环境优化\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				网站数据部署指导\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n			<td class=\"hook\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background:url(http://www.jspxcms.com/template/1/website/_files/images/icon/attr.jpg) 45px 5px no-repeat;\">\r\n				&nbsp;\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				产品使用培训\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				&nbsp;\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;\">\r\n				12小时\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n<table class=\"purch-table ke-zeroborder\" width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"padding:0px;margin:0px;color:#575757;font-family:Arial, Helvetica, sans-serif, 微软雅黑, 宋体;font-size:12px;background-color:#F1F1F1;\">\r\n	<tbody style=\"padding:0px;margin:0px;\">\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<th colspan=\"6\" scope=\"col\" style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;background-color:#E3F3EB;\">\r\n				相关说明\r\n			</th>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				使用期限\r\n			</td>\r\n			<td width=\"110\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				终身\r\n			</td>\r\n			<td width=\"110\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				终身\r\n			</td>\r\n			<td width=\"110\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				终身\r\n			</td>\r\n			<td width=\"110\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				终身\r\n			</td>\r\n			<td width=\"110\" style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;\">\r\n				终身\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				免费升级期限\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				终身\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				终身\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				终身\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				终身\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;\">\r\n				终身\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				技术支持期限\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				无\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				1年\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				1年\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				1年\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;\">\r\n				1年\r\n			</td>\r\n		</tr>\r\n		<tr bgcolor=\"#FFFFFF\" style=\"padding:0px;margin:0px;\">\r\n			<td style=\"padding:0px 0px 0px 10px;margin:0px;height:28px;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				服务网站数量\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				1个\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				1个\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				1个\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-width:1px;border-right-style:solid;border-right-color:#94CFE4;\">\r\n				1个\r\n			</td>\r\n			<td style=\"padding:0px;margin:0px;height:28px;text-align:center;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#94CFE4;border-right-style:none;\">\r\n				1个\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n<div style=\"padding:20px;margin:20px;color:#575757;font-family:Arial, Helvetica, sans-serif, 微软雅黑, 宋体;line-height:normal;white-space:normal;border:1px solid #94CFE4;background-color:#E3F3EB;\">\r\n	<ul style=\"padding:0px;margin:0px;list-style:none;color:red;\">\r\n		<li style=\"padding:0px;margin:0px;\">\r\n			说明：\r\n		</li>\r\n		<li style=\"padding:0px;margin:0px;\">\r\n			一、以下情况不属于服务范围\r\n		</li>\r\n		<li style=\"padding:0px;margin:0px;\">\r\n			自行修改、二次开发或使用非原始JSPXCMS程序代码产生的问题；\r\n		</li>\r\n		<li style=\"padding:0px;margin:0px;\">\r\n			自行对数据库进行直接操作导致数据库出错或者崩溃；\r\n		</li>\r\n		<li style=\"padding:0px;margin:0px;\">\r\n			插件、第三方软件的安装造成的系统故障；\r\n		</li>\r\n		<li style=\"padding:0px;margin:0px;\">\r\n			服务器、虚拟主机原因造成的系统故障；\r\n		</li>\r\n		<li style=\"padding:0px;margin:0px;\">\r\n			自然灾害造成的任何损坏；\r\n		</li>\r\n		<li style=\"padding:0px;margin:0px;\">\r\n			二、JSPXCMS可选模块需要结合商业版使用，目前暂不支持单独使用。\r\n		</li>\r\n	</ul>\r\n</div>', '\0', '\0', '', '', 'jspxcms', '18.000000', 'jspxcms', '6', '2014-11-18 15:54:11', '0', '2014-11-18 12:23:09', '小米商城', '15', '15.000000', '0', '5', '1', 'jspxcms', 'jspxcms', 'jspxcms', '201411709', null, null, '5', null, '6', '2014-11-18 15:54:11', '0', '2014-11-18 12:23:09', null, '4', '66', '10', null);
INSERT INTO `xx_product` VALUES ('308', '2014-11-18 12:23:09', '2014-12-09 22:20:13', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, '小米商城[jspxcms 3.1]', '22', null, null, '\0', '', '', '', 'jspxcms', '18.000000', 'jspxcms', '12', '2014-12-04 22:30:53', '0', '2014-11-18 12:23:09', '小米商城', '15', '15.000000', '0', '0', '0', 'jspxcms', 'jspxcms', 'jspxcms', '201411710', null, null, '0', null, '13', '2014-12-04 22:30:53', '0', '2014-11-18 12:23:09', null, '4', '66', '10', null);
INSERT INTO `xx_product` VALUES ('309', '2014-12-10 21:43:13', '2014-12-10 21:45:21', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, '大自然网站 opencms支持[opencms 9.5]', '0', 'http://127.0.0.1:8080/upload/image/2.jpg', '<img src=\"http://127.0.0.1:8080/upload/image/1.jpg\" alt=\"\" /><img src=\"http://127.0.0.1:8080/upload/image/2.jpg\" alt=\"\" />', '\0', '\0', '', '\0', null, '1200.000000', null, '0', '2014-12-10 21:43:13', '0', '2014-12-10 21:43:13', '大自然网站 opencms支持', '1000', '1000.000000', '0', '0', '0', null, null, null, '201412808', null, null, '0', null, '0', '2014-12-10 21:43:13', '0', '2014-12-10 21:43:13', null, '18', '67', '2', null);
INSERT INTO `xx_product` VALUES ('310', '2014-12-10 21:43:13', '2014-12-10 21:43:13', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, '大自然网站[opencms 9.x]', '0', 'http://127.0.0.1:8080/upload/image/2.jpg', '<img src=\"http://127.0.0.1:8080/upload/image/1.jpg\" alt=\"\" /><img src=\"http://127.0.0.1:8080/upload/image/2.jpg\" alt=\"\" />', '\0', '\0', '', '\0', null, '1200.000000', null, '0', '2014-12-10 21:43:13', '0', '2014-12-10 21:43:13', '大自然网站', '1000', '1000.000000', '0', '0', '0', null, null, null, '201412809', null, null, '0', null, '0', '2014-12-10 21:43:13', '0', '2014-12-10 21:43:13', null, '18', '67', '2', null);
INSERT INTO `xx_product` VALUES ('311', '2014-12-10 21:43:13', '2014-12-10 21:43:13', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, '大自然网站[opencms 8.x]', '0', 'http://127.0.0.1:8080/upload/image/2.jpg', '<img src=\"http://127.0.0.1:8080/upload/image/1.jpg\" alt=\"\" /><img src=\"http://127.0.0.1:8080/upload/image/2.jpg\" alt=\"\" />', '\0', '\0', '', '\0', null, '1200.000000', null, '0', '2014-12-10 21:43:13', '0', '2014-12-10 21:43:13', '大自然网站', '1000', '1000.000000', '0', '0', '0', null, null, null, '201412810', null, null, '0', null, '0', '2014-12-10 21:43:13', '0', '2014-12-10 21:43:13', null, '18', '67', '2', null);
INSERT INTO `xx_product` VALUES ('312', '2014-12-10 21:43:13', '2014-12-10 22:08:10', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, '大自然网站 jeecms支持[opencms 7.x]', '0', 'http://127.0.0.1:8080/upload/image/2.jpg', '<img src=\"http://127.0.0.1:8080/upload/image/1.jpg\" alt=\"\" /><img src=\"http://127.0.0.1:8080/upload/image/2.jpg\" alt=\"\" />', '\0', '', '', '\0', null, '1200.000000', null, '0', '2014-12-10 21:43:13', '0', '2014-12-10 21:43:13', '大自然网站 jeecms支持', '1000', '1000.000000', '0', '0', '0', null, null, null, '201412811', null, null, '0', null, '0', '2014-12-10 21:43:13', '0', '2014-12-10 21:43:13', null, '18', '67', '2', null);
...
-- ----------------------------
INSERT INTO `xx_product_product_image` VALUES ('304', 'http://127.0.0.1:8080/upload/image/201412/ee1700db-b273-4f16-ae41-1e20712b8b06-large.jpg', 'http://127.0.0.1:8080/upload/image/201412/ee1700db-b273-4f16-ae41-1e20712b8b06-medium.jpg', null, 'http://127.0.0.1:8080/upload/image/201412/ee1700db-b273-4f16-ae41-1e20712b8b06-source.jpg', 'http://127.0.0.1:8080/upload/image/201412/ee1700db-b273-4f16-ae41-1e20712b8b06-thumbnail.jpg', null);
INSERT INTO `xx_product_product_image` VALUES ('304', 'http://127.0.0.1:8080/upload/image/201412/bf2c14c5-0ead-4bc2-84b3-57625d1a3dc2-large.jpg', 'http://127.0.0.1:8080/upload/image/201412/bf2c14c5-0ead-4bc2-84b3-57625d1a3dc2-medium.jpg', null, 'http://127.0.0.1:8080/upload/image/201412/bf2c14c5-0ead-4bc2-84b3-57625d1a3dc2-source.jpg', 'http://127.0.0.1:8080/upload/image/201412/bf2c14c5-0ead-4bc2-84b3-57625d1a3dc2-thumbnail.jpg', null);
INSERT INTO `xx_product_product_image` VALUES ('304', 'http://127.0.0.1:8080/upload/image/201412/6f09e1ea-765a-4ecb-acbf-6c8c48d08b8b-large.jpg', 'http://127.0.0.1:8080/upload/image/201412/6f09e1ea-765a-4ecb-acbf-6c8c48d08b8b-medium.jpg', null, 'http://127.0.0.1:8080/upload/image/201412/6f09e1ea-765a-4ecb-acbf-6c8c48d08b8b-source.jpg', 'http://127.0.0.1:8080/upload/image/201412/6f09e1ea-765a-4ecb-acbf-6c8c48d08b8b-thumbnail.jpg', null);
...
INSERT INTO `xx_product_product_image` VALUES ('310', 'http://127.0.0.1:8080/upload/image/201412/86fe5203-dfbc-49d0-bfe8-fdf399dd2d1b-large.jpg', 'http://127.0.0.1:8080/upload/image/201412/86fe5203-dfbc-49d0-bfe8-fdf399dd2d1b-medium.jpg', null, 'http://127.0.0.1:8080/upload/image/201412/86fe5203-dfbc-49d0-bfe8-fdf399dd2d1b-source.jpg', 'http://127.0.0.1:8080/upload/image/201412/86fe5203-dfbc-49d0-bfe8-fdf399dd2d1b-thumbnail.jpg', null);
INSERT INTO `xx_product_product_image` VALUES ('310', 'http://127.0.0.1:8080/upload/image/201412/01cb8e2b-5d23-4a11-9ba8-e699132d988b-large.jpg', 'http://127.0.0.1:8080/upload/image/201412/01cb8e2b-5d23-4a11-9ba8-e699132d988b-medium.jpg', null, 'http://127.0.0.1:8080/upload/image/201412/01cb8e2b-5d23-4a11-9ba8-e699132d988b-source.jpg', 'http://127.0.0.1:8080/upload/image/201412/01cb8e2b-5d23-4a11-9ba8-e699132d988b-thumbnail.jpg', null);
INSERT INTO `xx_product_product_image` VALUES ('311', 'http://127.0.0.1:8080/upload/image/201412/86fe5203-dfbc-49d0-bfe8-fdf399dd2d1b-large.jpg', 'http://127.0.0.1:8080/upload/image/201412/86fe5203-dfbc-49d0-bfe8-fdf399dd2d1b-medium.jpg', null, 'http://127.0.0.1:8080/upload/image/201412/86fe5203-dfbc-49d0-bfe8-fdf399dd2d1b-source.jpg', 'http://127.0.0.1:8080/upload/image/201412/86fe5203-dfbc-49d0-bfe8-fdf399dd2d1b-thumbnail.jpg', null);
INSERT INTO `xx_product_product_image` VALUES ('311', 'http://127.0.0.1:8080/upload/image/201412/01cb8e2b-5d23-4a11-9ba8-e699132d988b-large.jpg', 'http://127.0.0.1:8080/upload/image/201412/01cb8e2b-5d23-4a11-9ba8-e699132d988b-medium.jpg', null, 'http://127.0.0.1:8080/upload/image/201412/01cb8e2b-5d23-4a11-9ba8-e699132d988b-source.jpg', 'http://127.0.0.1:8080/upload/image/201412/01cb8e2b-5d23-4a11-9ba8-e699132d988b-thumbnail.jpg', null);
INSERT INTO `xx_product_product_image` VALUES ('309', 'http://127.0.0.1:8080/upload/image/201412/86fe5203-dfbc-49d0-bfe8-fdf399dd2d1b-large.jpg', 'http://127.0.0.1:8080/upload/image/201412/86fe5203-dfbc-49d0-bfe8-fdf399dd2d1b-medium.jpg', null, 'http://127.0.0.1:8080/upload/image/201412/86fe5203-dfbc-49d0-bfe8-fdf399dd2d1b-source.jpg', 'http://127.0.0.1:8080/upload/image/201412/86fe5203-dfbc-49d0-bfe8-fdf399dd2d1b-thumbnail.jpg', null);
INSERT INTO `xx_product_product_image` VALUES ('309', 'http://127.0.0.1:8080/upload/image/201412/01cb8e2b-5d23-4a11-9ba8-e699132d988b-large.jpg', 'http://127.0.0.1:8080/upload/image/201412/01cb8e2b-5d23-4a11-9ba8-e699132d988b-medium.jpg', null, 'http://127.0.0.1:8080/upload/image/201412/01cb8e2b-5d23-4a11-9ba8-e699132d988b-source.jpg', 'http://127.0.0.1:8080/upload/image/201412/01cb8e2b-5d23-4a11-9ba8-e699132d988b-thumbnail.jpg', null);
INSERT INTO `xx_product_product_image` VALUES ('312', 'http://127.0.0.1:8080/upload/image/201412/86fe5203-dfbc-49d0-bfe8-fdf399dd2d1b-large.jpg', 'http://127.0.0.1:8080/upload/image/201412/86fe5203-dfbc-49d0-bfe8-fdf399dd2d1b-medium.jpg', null, 'http://127.0.0.1:8080/upload/image/201412/86fe5203-dfbc-49d0-bfe8-fdf399dd2d1b-source.jpg', 'http://127.0.0.1:8080/upload/image/201412/86fe5203-dfbc-49d0-bfe8-fdf399dd2d1b-thumbnail.jpg', null);
INSERT INTO `xx_product_product_image` VALUES ('312', 'http://127.0.0.1:8080/upload/image/201412/01cb8e2b-5d23-4a11-9ba8-e699132d988b-large.jpg', 'http://127.0.0.1:8080/upload/image/201412/01cb8e2b-5d23-4a11-9ba8-e699132d988b-medium.jpg', null, 'http://127.0.0.1:8080/upload/image/201412/01cb8e2b-5d23-4a11-9ba8-e699132d988b-source.jpg', 'http://127.0.0.1:8080/upload/image/201412/01cb8e2b-5d23-4a11-9ba8-e699132d988b-thumbnail.jpg', null);
...
INSERT INTO `xx_product_specification` VALUES ('301', '7');
INSERT INTO `xx_product_specification` VALUES ('302', '3');
INSERT INTO `xx_product_specification` VALUES ('302', '7');
INSERT INTO `xx_product_specification` VALUES ('303', '3');
INSERT INTO `xx_product_specification` VALUES ('303', '7');
INSERT INTO `xx_product_specification` VALUES ('304', '3');
INSERT INTO `xx_product_specification` VALUES ('304', '7');
INSERT INTO `xx_product_specification` VALUES ('305', '6');
INSERT INTO `xx_product_specification` VALUES ('305', '7');
...
INSERT INTO `xx_product_specification` VALUES ('309', '3');
INSERT INTO `xx_product_specification` VALUES ('309', '7');
INSERT INTO `xx_product_specification` VALUES ('310', '3');
INSERT INTO `xx_product_specification` VALUES ('310', '7');
INSERT INTO `xx_product_specification` VALUES ('311', '3');
INSERT INTO `xx_product_specification` VALUES ('311', '7');
INSERT INTO `xx_product_specification` VALUES ('312', '3');
INSERT INTO `xx_product_specification` VALUES ('312', '7');
...
INSERT INTO `xx_product_specification_value` VALUES ('301', '82');
INSERT INTO `xx_product_specification_value` VALUES ('302', '78');
INSERT INTO `xx_product_specification_value` VALUES ('302', '82');
INSERT INTO `xx_product_specification_value` VALUES ('303', '77');
INSERT INTO `xx_product_specification_value` VALUES ('303', '82');
INSERT INTO `xx_product_specification_value` VALUES ('304', '49');
INSERT INTO `xx_product_specification_value` VALUES ('304', '82');
INSERT INTO `xx_product_specification_value` VALUES ('305', '67');
INSERT INTO `xx_product_specification_value` VALUES ('305', '88');
...
INSERT INTO `xx_product_specification_value` VALUES ('309', '79');
INSERT INTO `xx_product_specification_value` VALUES ('309', '82');
INSERT INTO `xx_product_specification_value` VALUES ('310', '78');
INSERT INTO `xx_product_specification_value` VALUES ('310', '82');
INSERT INTO `xx_product_specification_value` VALUES ('311', '77');
INSERT INTO `xx_product_specification_value` VALUES ('311', '82');
INSERT INTO `xx_product_specification_value` VALUES ('312', '49');
INSERT INTO `xx_product_specification_value` VALUES ('312', '82');
...
-- Records of xx_sn
-- ----------------------------
INSERT INTO `xx_sn` VALUES ('1', '2014-11-03 00:59:51', '2014-12-10 21:43:13', '9', '0');
...
-- ----------------------------
INSERT INTO `xx_specification` VALUES ('3', '2014-11-03 00:12:41', '2014-11-18 12:19:39', '3', 'opencms版本号', '支持版本', '0');
INSERT INTO `xx_specification` VALUES ('4', '2014-11-03 00:12:42', '2014-11-18 12:19:49', '4', 'jspxcms版本号', '支持版本', '0');
INSERT INTO `xx_specification` VALUES ('5', '2014-11-03 00:12:43', '2014-11-18 12:20:06', '5', 'jeecms版本号', '支持版本', '0');
INSERT INTO `xx_specification` VALUES ('6', '2014-11-03 00:12:44', '2014-11-18 12:20:02', '6', 'es版本号', '支持版本', '0');
INSERT INTO `xx_specification` VALUES ('7', '2014-11-18 12:17:05', '2014-11-18 12:18:52', '1', '支持的系统名称', '支持系统', '0');
